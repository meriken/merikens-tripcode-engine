...
#define w(p, q)    DES_VECTOR_XOR_FUNC(DESContextArray[threadIdx.x].dataBlocks[p], DESContextArray[threadIdx.x].keys[q])
...
void DES_Crypt()
{
	...
	switch (threadIdx.y) {
	case 0: 
		E0 = CUDA_expansionFunction[0];
		E1 = CUDA_expansionFunction[1];
		E2 = CUDA_expansionFunction[2];
		E3 = CUDA_expansionFunction[3];
		E4 = CUDA_expansionFunction[4];
		E5 = CUDA_expansionFunction[5];
		break;
	case 1: 
		E0 = CUDA_expansionFunction[6];
		E1 = CUDA_expansionFunction[7];
		E2 = CUDA_expansionFunction[8];
		E3 = CUDA_expansionFunction[9];
		E4 = CUDA_expansionFunction[10];
		E5 = CUDA_expansionFunction[11];
		break;
	case 2: 
		E0 = CUDA_expansionFunction[24];
		E1 = CUDA_expansionFunction[25];
		E2 = CUDA_expansionFunction[26];
		E3 = CUDA_expansionFunction[27];
		E4 = CUDA_expansionFunction[28];
		E5 = CUDA_expansionFunction[29];
		break;
	case 3: 
		E0 = CUDA_expansionFunction[30];
		E1 = CUDA_expansionFunction[31];
		E2 = CUDA_expansionFunction[32];
		E3 = CUDA_expansionFunction[33];
		E4 = CUDA_expansionFunction[34];
		E5 = CUDA_expansionFunction[35];
		break;
	}

start:
	switch (threadIdx.y) {
	case 0: s1(y(E0,  0), y(E1,  1), y(E2,  2), y(E3,  3), y(E4,  4), y(E5,  5), z(40), z(48), z(54), z(62));
	        s8(y(27, 42), y(28, 43), y(29, 44), y(30, 45), y(31, 46), y( 0, 47), z(36), z(58), z(46), z(52)); break;
	case 1: s3(y( 7, 12), y( 8, 13), y( 9, 14), y(10, 15), y(11, 16), y(12, 17), z(55), z(47), z(61), z(37));
	        s2(y(E0,  6), y(E1,  7), y(E2,  8), y(E3,  9), y(E4, 10), y(E5, 11), z(44), z(59), z(33), z(49)); break;
	case 2: s5(y(E0, 24), y(E1, 25), y(E2, 26), y(E3, 27), y(E4, 28), y(E5, 29), z(39), z(45), z(56), z(34));
	        s4(y(11, 18), y(12, 19), y(13, 20), y(14, 21), y(15, 22), y(16, 23), z(57), z(51), z(41), z(32)); break;
	case 3: s7(y(23, 36), y(24, 37), y(25, 38),	y(26, 39), y(27, 40), y(28, 41), z(63), z(43), z(53), z(38));
	        s6(y(E0, 30), y(E1, 31), y(E2, 32), y(E3, 33), y(E4, 34), y(E5, 35), z(35), z(60), z(42), z(50)); break;
	}
	__syncthreads();
...
swap:
	switch (threadIdx.y) {
	case 0: s1(y(E0+32, 48), y(E1+32, 49), y(E2+32, 50), y(E3+32, 51),     y(E4+32, 52),     y(E5+32, 53),     z( 8), z(16), z(22), z(30));
	        s8(y(59,    90), y(60,    91), y(61,    92), y(62, 93), y(63, 94), y(32, 95), z( 4), z(26), z(14), z(20)); break;
	case 1: s3(y(39,    60), y(40,    61), y(41,    62), y(42, 63), y(43, 64), y(44, 65), z(23), z(15), z(29), z( 5));
	        s2(y(E0+32, 54), y(E1+32, 55), y(E2+32, 56), y(E3+32, 57),     y(E4+32, 58),     y(E5+32, 59),     z(12), z(27), z( 1), z(17)); break;
	case 2: s5(y(E0+32, 72), y(E1+32, 73), y(E2+32, 74), y(E3+32, 75),     y(E4+32, 76),     y(E5+32, 77),     z( 7), z(13), z(24), z( 2));
	        s4(y(43,    66), y(44,    67), y(45,    68), y(46, 69), y(47, 70), y(48, 71), z(25), z(19), z( 9), z( 0)); break;
	case 3: s7(y(55,    84), y(56,    85), y(57,    86), y(58, 87), y(59, 88), y(60, 89), z(31), z(11), z(21), z( 6));
	        s6(y(E0+32, 78), y(E1+32, 79), y(E2+32, 80), y(E3+32, 81),     y(E4+32, 82),     y(E5+32, 83),     z( 3), z(28), z(10), z(18)); break;
	}	
	__syncthreads();
