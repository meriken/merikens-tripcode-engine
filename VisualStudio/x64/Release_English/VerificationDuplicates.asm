...
_BSS	ENDS
	ORG $+1
$SG4294875554 DB '%d', 0aH, 00H
$SG4294875552 DB 'Not enough memory', 00H
	ORG $+6
$SG4294875553 DB '[error],%d', 0aH, 00H
	ORG $+4
$SG4294875551 DB 0aH, 'ERROR', 0aH, '=====', 0aH, '  %s', 0aH, 07H, 0aH, ' '
...
; 109  : 	ERROR0(newNode == NULL, ERROR_NO_MEMORY, "Not enough memory");
	...
	call	__iob_func
	lea	rdx, OFFSET FLAT:$SG4294875554
	mov	r8d, 5
	...
	lea	rcx, QWORD PTR [rax+96]
	call	fflush
	lea	rcx, OFFSET FLAT:$SG4294875553
	mov	edx, 5
	call	printf
	call	__iob_func
...
; 109  : 	ERROR0(newNode == NULL, ERROR_NO_MEMORY, "Not enough memory");
	...
	lea	rdx, OFFSET FLAT:$SG4294875552
	lea	rcx, OFFSET FLAT:$SG4294875551
	call	printf
	call	_getch
; File z:\github\merikens-tripcode-engine\sourcefiles\main.cpp
